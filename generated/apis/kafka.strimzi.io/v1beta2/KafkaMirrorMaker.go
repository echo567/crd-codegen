...
type KafkaMirrorMakerSpec struct {
	...
	Consumer *KafkaMirrorMakerSpecConsumer `json:"consumer,omitempty" yaml:"consumer,omitempty" mapstructure:"consumer,omitempty"`
	...
	Producer *KafkaMirrorMakerSpecProducer `json:"producer,omitempty" yaml:"producer,omitempty" mapstructure:"producer,omitempty"`
